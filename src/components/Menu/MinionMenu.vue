<template>
    <div class="flex justify-center items-center flex-col">
        ...
        <p class="m-b-2px">
            ...
            <input type="radio" name="kind-type" v-model="cardKindType" :value="KindType.Single"/><span>{{ $t("singleKind") }}</span>
            <input type="radio" name="kind-type" v-model="cardKindType" :value="KindType.Dual"/><span>{{ $t("dualKinds") }}</span>
        </p>
